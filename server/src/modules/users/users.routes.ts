...
router.post('/', validate(createUserSchema), (req, res, next) => controller.create(req as AuthRequest, res, next));
router.put('/:id', validate(updateUserSchema), (req, res, next) => controller.update(req as AuthRequest, res, next));
